        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Active</td>
                    <td>
                        <a type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#editModal{{$user->id}}">Edit</a>
                        <!-- Edit -->
                        ...
                        <form action="{{route('banuser', $user->id)}}" method="POST">
                            @csrf
                            @method('POST')
                            <button type="submit" class="btn btn-dark" onclick="return confirm('Are you sure you want to Ban This User?')">Ban</button>
                        </form>
                    </td>
                    @else
